...
function Background(props){
    ...
    return(
        <div data-aos="zoom-in" data-aos-duration="1500" className=''>
            <div>
                <div className="flex flex-row mx-auto justify-center sm:flex flex-row space-x-5 mx-auto justify-center">
                    <div>
                ...
                Exclusive</span> Products <span></span></h2>
                    </div>

                    <div>
                    <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
	 width="50px" height="50px" viewBox="0 0 323.057 323.057"
	 xmlSpace="preserve">
<g>
	<g>
		<path d="M281.442,256.312c-47.124,59.364-139.536,44.676-160.956-29.376c-1.224-3.672-1.836-7.956-2.448-11.628
		...
		<path d="M315.713,233.668c-17.136,0-34.884,1.224-51.408,5.508c-6.731,1.836-3.672,11.016,3.061,9.792
